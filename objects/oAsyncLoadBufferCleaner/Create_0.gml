...
//Because the async load was independant of framerate, you can't reliably know if the buffer has been destroyed when you try to read it. This results in a crash.
