///@description Basically just here to organize the method mPopulateWorldChunk more. This part loads the tile decorum. The walls need to be stored permanently because they are drawn to a surface to help FPS. Surfaces are volatile and might need to be remade.
...
if (ds_exists(_chunk.terrainDecorum, ds_type_grid))
{
	ds_grid_destroy(_chunk.terrainDecorum);
}
_chunk.terrainDecorum = _grid;